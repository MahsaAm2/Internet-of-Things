...
#######  initial settings ##############
###### deployment setting ###########
NUMBER_NODES = 49  # the number of nodes in the network
...
#for i17 in range(
    ...
    #for j17 in range(int(NUMBER_NODES / math.sqrt(NUMBER_NODES))):
       # x1 = random.randint(1,ENVIRONMENT)
       # x.append(x1)
        #y1 = random.randint(1,ENVIRONMENT)
        #y.append(y1)
##############################################

 # the dimension of the environment (square) i meters that the network nodes are spread in it

x= [24, 40, 13, 34, 31, 36, 35, 28, 13, 18, 27, 12, 5, 23, 
    21, 1, 23, 4, 7, 6, 7, 8, 4, 21, 39, 29, 37, 19, 16, 29,
    7, 19, 9, 14, 34, 32, 31, 35, 11, 22, 8, 7, 36, 33, 39, 
    37, 14, 39, 14, 18, 37, 30, 4, 39, 13, 34, 4, 23, 35, 28, 19, 2, 
    17, 20, 27, 10, 26, 29, 20, 15, 16, 11, 1, 23, 27, 2, 40, 39, 27, 23, 30, 23, 22, 5]
y=[11, 35, 36, 34, 7, 39, 25, 33,
   10, 22, 12, 34, 17, 27, 32, 3, 36, 4, 9,
   10, 20, 2, 15, 18, 8, 29, 24, 14, 19, 11, 6, 8, 22, 40, 40, 29, 17, 25, 36, 22, 9, 26, 18, 17, 16, 24, 22, 13, 
   12, 40, 40, 26, 7, 26, 23, 12, 29, 5, 14,
   19, 6, 11, 24, 7, 6, 17, 39, 3, 9, 11, 25, 2, 9,
   1, 36, 23, 5, 36, 39, 10, 34, 18, 34, 40]
